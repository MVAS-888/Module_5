...
contact2 = Contact("Сидоренко", "Олег", 28, "+380661234567", "sydorenko@example.com")
update_contact1 = UpdateContact("Петров", "Петро", 35, "+380671234567", "petrov@example.com", "Інженер")
update_contact2 = UpdateContact("Коваленко", "Марина", 40, "+380931234567", "kovalenko@example.com", "Дизайнер")
...
print("contact1 є екземпляром Contact:", isinstance(contact1, Contact))
print("contact2 є екземпляром Contact:", isinstance(contact2, Contact))
print("update_contact1 є екземпляром UpdateContact:", isinstance(update_contact1, UpdateContact))
print("update_contact2 є екземпляром UpdateContact:", isinstance(update_contact2, UpdateContact))
print("update_contact1 є екземпляром Contact:", isinstance(update_contact1, Contact))
print("UpdateContact є підкласом Contact:", issubclass(UpdateContact, Contact))
